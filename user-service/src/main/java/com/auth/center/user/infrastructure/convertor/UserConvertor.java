...
public class UserConvertor {
    ...
    public User toDomain(UserPO userPO) {
        ...
        // 需要根据code转换为枚举
        user.setStatus(com.auth.center.user.domain.enums.UserStatus.fromCode(userPO.getStatus()));
        user.setUserType(com.auth.center.user.domain.enums.UserType.fromCode(userPO.getUserType()));
